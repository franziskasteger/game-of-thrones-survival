...
def create_character_alive(
    ...
    text_prompt = f"""
        ...
        Craft a captivating narrative about a Game of Thrones {'he' if character['male'][0] else 'she'}
        character who defied the odds and found their own unconventional happily
        ever after. Let your imagination run wild, take your time, and infuse
        a touch of humor along the way.
    """
